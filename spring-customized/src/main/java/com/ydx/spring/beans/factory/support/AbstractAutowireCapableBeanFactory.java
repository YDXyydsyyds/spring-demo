...
import com.ydx.spring.beans.factory.*;
import com.ydx.spring.beans.factory.config.*;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    protected Object initializeBean(String beanName, Object bean, BeanDefinition beanDefinition){
        ...
        try {
           invokeInitMethod(beanName, wrapperBean, beanDefinition);
            ...
            return new BeansException("Invocation of init method of bean[" + beanName + "] failed",ex);
        }
    ...
    protected void applyBeanPostProcessorBeforeApplyingPropertyValues(String beanName, Object bean, BeanDefinition beanDefinition){
        for (BeanPostProcessor beanPostProcessor : getBeanPostProcessors()) {
            if(beanPostProcessor instanceof  InstantiationAwareBeanPostProcessor){
                PropertyValues pvs =((InstantiationAwareBeanPostProcessor)beanPostProcessor).postProcessProperValues(beanDefinition.getPropertyValues(), bean, beanName);
                if(pvs != null){
